            ...
            <section>
                ...
                <div class="container">
                    ...
                    <section class="container cshadow breadcrumbs t3-sl t3-sl-1">
                        ...
                        <ul class="breadcrumb ">
                            <li class="active"></li><li><a href="index.jsp" ><i class="fa fa-home" aria-hidden="true"></i> Inicio</a></li><li><a href="#" >Formaciòn</a></li><li><span>Tesis</span></li>
                        </ul>
                                    ...
                                    <div class="col-md-3">
                                        <div id="accordion" class="panel panel-primary behclick-panel">
                                            <div class="panel-heading">
                                                <h3 class="panel-title">Busqueda por filtro</h3>
                                            </div>
                                            <div class="panel-body" >
                                                <div class="panel-heading " >
                                                    <div class="panel-title">
                                                        <a data-toggle="collapse" href="#collapse0">
                                                            <div  class="fa fa-caret-down" aria-hidden="true"></div> Categorìa
                                                        </a>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="panel-heading" >
                                                    <h4 class="panel-title">
                                                        <a data-toggle="collapse" href="#collapse3"><i class="indicator fa fa-caret-right" aria-hidden="true"></i> Otros</a>
                                                    </h4>
                                                </div>
                                        ...
                                        <article>
                                            <div class="row container-fluid">
                                                <div class="col-sm-6 col-md-2">
                                                    <figure>
                                                        <img src="images/tesis.png">
                                                    </figure>
                                                    <div><span >Tesis</span></div>
                                                </div>
                                                <div class="col-sm-6 col-md-10">
                                                    <div class="direc-text">
                                                        <h4><a href="paginanoticia.html">Lambayeque: implementan centro de investigación tecnológica en UNPRG</a></h4>
