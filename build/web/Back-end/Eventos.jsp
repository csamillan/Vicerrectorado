...
<jsp:include page="../sEvento?opcion=ListarEventos"/>
<jsp:useBean id="ListarEventos" scope="request" class="java.util.ArrayList"/>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
                                    ...
                                    <div class="box-body">                  
                                        <div class="nav-tabs-custom">
                                            <ul class="nav nav-tabs pull-lef">
                                                <li class="active"><a href="#tab_1" data-toggle="tab"><i class="fa fa-file-text-o"></i>Evento</a></li>
                                                <li class="noti"><a href="#tab_2" data-toggle="tab"><i class="fa fa-file-text-o"></i> Agregar Evento</a></li>
                                            </ul>
                                                            ...
                                                            <article style="border: 1px solid  #969696; margin: 10px; ">
                                                                <div class="row">
                                                                    <div class="col-sm-4 col-md-4" >
                                                                        <figure >
                                                                            <img src="dist/img/eventos/<%out.println(inv.getImagen());%>" class="img-responsive" style="width:400px; height: 200px;">
                                                                        </figure>
                                                                    </div>
                                            ...
                                            <div class="tab-pane" id="tab_2">
                                                <div class="container-fluid">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <form action="../sEvento" method="post" accept-charset="utf-8" id="sEvento" enctype="multipart/form-data">  
                                                                ...
                                                                <div class="form-group col-md-6">
                                                                    ...
                                                                    <input type="date" class="form-control" id="fecha" name="fecha" placeholder="Fecha del Evento" />
                                                                </div>
                                                                <div class="form-group col-md-6">
                                                                    <label>
                                                                        Hora del Evento
                                                                    </label>
                                                                    <input type="text" class="form-control" id="hora" name="hora" placeholder="Hora del Evento" />
                                                                </div>
                                                                <div class="form-group col-md-12">
                                                                    <label>
                                                                        Lugar del Evento
                                                                ...
                                                                <div class="form-group col-md-12">
                                                                    ...
                                                                    <textarea cols="30" rows="10"  class="form-control" id="contenido" name="contenido" placeholder="Descripcion del Evento" ></textarea>  
                                                                </div>
                                                                <div class="form-group col-md-12">
                                                                    <div align="center" >
